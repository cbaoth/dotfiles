...
[Unit]
Description=Run Bedtime Script every 10 min (21:30 - 05:00)

[Timer]
# Cover 21:30 to 21:50 in 10 min intervals
OnCalendar=*-*-* 21:30,40,50

# Cover 22:00 to 23:50 in 10 min intervals
OnCalendar=*-*-* 22,23:0/10

# Cover 00:00 to 04:50 in 10 min intervals
OnCalendar=*-*-* 00..04:0/10

# Final trigger at 05:00 (not really needed if "Bedtime Zone" ends at 05:00)
#OnCalendar=*-*-* 05:00:00
