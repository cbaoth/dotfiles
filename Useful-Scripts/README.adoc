## Some random bash/python scripts

Created and intended for my personal use only. Some of these are ancient and most not well maintaind, so if anyone stumbles upon this repo: Be warned, read/use at your own risk. :)
