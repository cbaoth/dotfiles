...
Optionally, you can only restrict specific services like `login` and `sudo` by replacing the first asterisk (`*`) in the line with the service name.

[source,shell]
----
# <service>: <tty>: <user>: <time>
login; *; youruser; !Al2100-0500
sudo; *; youruser; !Al2100-0500
----
