...
Every script should start with a metadata header immediately after the shebang:

[source,bash]
----
#!/usr/bin/env bash
# ~/bin/script-name: Brief description of the script
# code: language=bash insertSpaces=true tabSize=2
# keywords: bash shell relevant-keywords
# author: Andreas Weyer
----

For libraries (no shebang):

[source,bash]
----
# ~/lib/commons.sh: Common shell function library
# code: language=bash insertSpaces=true tabSize=2
# keywords: zsh bash lib shell shell-script
# author: Andreas Weyer
#
# Additional notes (e.g., compatibility remarks)
----

=== Editor Modelines

The `# code: ...` header line is treated as an editor modeline and should be
kept in script headers where applicable:
...
If a Vim modeline is added later, keep both modelines semantically aligned
(indent width, tabs/spaces, etc.).
...
----
#!/usr/bin/env bash
# File header (description, metadata, author)
